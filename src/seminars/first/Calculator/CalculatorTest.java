...
public class CalculatorTest {
    ...
    public static void testCalculateDiscountWithValidArguments() {
        ...
        double result = Calculator.calculatingDiscount(purchaseAmount, discountPercent);
    ...
    public static void testCalculateDiscountWithInvalidArguments() {
        ...
        Assertions.assertThatThrownBy(() -> Calculator.calculatingDiscount(purchaseAmount, discountPercent))
